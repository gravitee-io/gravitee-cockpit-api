...
public class UnlinkInstallationReply extends CockpitReply<Payload> {
  ...
  public UnlinkInstallationReply(
    ...
    super(
      CockpitCommandType.UNLINK_INSTALLATION,
      commandId,
      CommandStatus.ERROR
    );
  ...
  public UnlinkInstallationReply(final String commandId) {
    super(
      CockpitCommandType.UNLINK_INSTALLATION,
      commandId,
