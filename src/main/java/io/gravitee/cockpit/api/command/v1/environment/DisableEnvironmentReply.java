...
public class DisableEnvironmentReply extends CockpitReply<Payload> {
  ...
  public DisableEnvironmentReply(
    ...
    super(
      CockpitCommandType.DISABLE_ENVIRONMENT,
      commandId,
      CommandStatus.ERROR
    );
  ...
  public DisableEnvironmentReply(final String commandId) {
    super(
      CockpitCommandType.DISABLE_ENVIRONMENT,
      commandId,
